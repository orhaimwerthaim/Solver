...
(1) Generate a file of min/max scores per instance for normalization.
      ...
      RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.MinMaxEval [--time-limit TIME] [--num-trials NUM] <directory of RDDL .log files>
    
    for example, the commands used to evaluate different competitions:
    
      IPPC 2011: RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.MinMaxEval --num-trials 30 FinalComp2011/MDP/
      IPPC 2014: RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.MinMaxEval --time-limit 1080000 --num-trials 30 FinalComp2014/MDP/

Simply run RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.MinMaxEval with the sole argument containing
...
(2) Process all log files and produce raw and normalized scores aggregated
    by instance, domain, and overall.
      ...
      RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.FinalEval [--time-limit TIME] [--num-trials NUM] <directory of RDDL .log files>
    
    for example, the commands used to evaluate different competitions:
    
      IPPC 2011: RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.FinalEval --num-trials 30 FinalComp/MDP/
      IPPC 2014: RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.FinalEval --time-limit 1080000 --num-trials 30 FinalComp/MDP/
    
Simply run RDDL2POMCP.RDDL2POMCP.RDDL2POMCP.rddl.evaluate.FinalEval with the sole argument containing
