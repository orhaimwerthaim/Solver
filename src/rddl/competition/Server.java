...
public class Server implements Runnable {
    public static final boolean ONLY_PARSE = true;//OrHaim
	...
	//public int numSimulatorActivations = 0;
...
//		MongoDB.Test();
	...
	public void run() {
		...
		try {
			...
			//if(DEFAULT_NUM_ROUNDS == 30) throw new Exception();
...
//			System.out.println(msg.substring(39));
	...
	public static synchronized InputSource readOneMessage(InputStream isr) {
		...
		try {
			...
			SendToROS.SendROSMessage(new String(bytes, StandardCharsets.UTF_8));
			return isrc;
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
